# Contributing to hoopla

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to hoopla. 
...
The hoopla team strives to create a
...
Please use our [Issue Tracker](https://github.com/cmungall/hoopla/issues/) for reporting problems with the ontology. 
